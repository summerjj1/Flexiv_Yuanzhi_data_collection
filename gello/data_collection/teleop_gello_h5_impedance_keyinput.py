    ...
    try:
        ...
        while True:
            ...
            # gello_controller.control_loop_callback()
              # 添加实时打印末端位置
            #logger.info(f"Current TCP Position: x={cmd_end_effector_pos[0]:.4f}, y={cmd_end_effector_pos[1]:.4f}, z={cmd_end_effector_pos[2]:.4f}")
            ...
            if not debug_sensor:
                ...
                robot.SendCartesianMotionForce([*cmd_end_effector_pos, cmd_quat_numpy.w, cmd_quat_numpy.x, cmd_quat_numpy.y, cmd_quat_numpy.z])
                gripper.Move(cmd_leader_gripper_pos, 0.15, 50)
...
if __name__ == "__main__":
    ...
    default_path = f"/media/forceyqj/My PSSD/601_flexiv_record_data/assemble_gears_demo/all_in_one/{current_date}/"
