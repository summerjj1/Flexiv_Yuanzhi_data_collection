...
def main(args):
    ...
    try:
        ...
        for pose, gripper_width in tqdm(zip(traj_pose, traj_gripper)):
            robot.SendJointPosition(pose, target_vel, target_acc, MAX_VEL, MAX_ACC)
            ...
            time.sleep(1 / 100)  # Adjust based on trajectory timing
...
if __name__ == "__main__":
    ...
    parser.add_argument('--gripper_name', type=str, default="Flexiv-GN01", 
                        help="Name of the gripper (default: GripperDahuanModbus)")
    parser.add_argument('--h5_file', type=str, default="/media/forceyqj/ZhqSSD/labdata/insert_wifi/2025-10-28/insert-wifi/trajectory_20251028_145026.h5",
