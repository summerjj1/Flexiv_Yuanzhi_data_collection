...
def compute_gravity_torques(q, urdf_path='/home/liyang/code_force_gello/gello_flexiv_SHAILab/CAD_files/urdf/force_gello_urdf_nofix/urdf/force_gello_urdf_nofix.urdf', g_value=9.81):
