...
def example_piper_robot(lmdb_path):
    ...
    rate = Rate(robot.controllers["piper_dual_arm"].args.frame_rate)
    # rate = Rate(30)
...
if __name__ == "__main__":
    example_piper_robot(
        "/home/pjlab/work/datasets/arx_dummy/Put_the_bowl_in_the_dinner_plate/lmdb"
        )
