...
if __name__ == "__main__":
    ...
    main(
        checkpoint_dir="/mnt/phwfile/efm_t/zhuyangkun_tmp_need_del/model/publish/pi0_base_libero",
        config_name="pi0_libero",
        output_path="/mnt/phwfile/efm_t/zhuyangkun_tmp_need_del/model/publish/pi0_base_libero/torch",
        precision="bfloat16",
    )
