...
"""
    ...
    def deserialize(self, str):
        ...
        try:
            ...
            (
                ...
                _x.head_pit,
                _x.head_yaw,
            ) = _get_struct_19d().unpack(str[start:end])
            start = end
            end += 48
    ...
    def deserialize_numpy(self, str, numpy):
        ...
        try:
            ...
            self.tempFloatData = numpy.frombuffer(
                str[start:end], dtype=numpy.float64, count=6
            )
            start = end
            end += 24
            self.tempIntData = numpy.frombuffer(
                str[start:end], dtype=numpy.int32, count=6
            )
            _x = self
            start = end
            end += 12
