...
"""autogenerated by genpy from arm_control/JointControl.msg. Do not edit."""
import codecs
import sys
...
class JointControl(genpy.Message):
    ...
    _type = "arm_control/JointControl"
...
int32 mode"""
    ...
    def deserialize_numpy(self, str, numpy):
        ...
        try:
            ...
            self.joint_pos = numpy.frombuffer(
                str[start:end], dtype=numpy.float32, count=7
            )
            start = end
            end += 28
            self.joint_vel = numpy.frombuffer(
                str[start:end], dtype=numpy.float32, count=7
            )
            start = end
            end += 28
            self.joint_cur = numpy.frombuffer(
                str[start:end], dtype=numpy.float32, count=7
            )
            start = end
            end += 4
